...
VeWindow::VeWindow(unsigned int w, unsigned int h,
...
void VeWindow::initWindow() {
    ...
    window =
        glfwCreateWindow(width, height, windowName.c_str(),
                         nullptr, nullptr);
...
void VeWindow::createWindowSurface(VkInstance instance,
...
void VeWindow::framebufferResizeCallback(GLFWwindow* window,
                                         int width,
                                         int height) {
