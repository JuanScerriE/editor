    ...
    for (const auto &avaliablePresentMode : availablePresentModes) {
        switch(avaliablePresentMode) {
            case VK_PRESENT_MODE_MAILBOX_KHR:
                std::cout << "Avaliable Present Mode: Mailbox" << std::endl; 
                break;
            case VK_PRESENT_MODE_FIFO_KHR:
                std::cout << "Avaliable Present Mode: Fifo" << std::endl; 
                break;
            case VK_PRESENT_MODE_IMMEDIATE_KHR:
                std::cout << "Avaliable Present Mode: Immediate" << std::endl; 
                break;
            case VK_PRESENT_MODE_FIFO_RELAXED_KHR:
                std::cout << "Avaliable Present Mode: Fifo Relaxed" << std::endl; 
                break;
            case VK_PRESENT_MODE_SHARED_DEMAND_REFRESH_KHR:
                std::cout << "Avaliable Present Mode: Shared Demand Refresh" << std::endl; 
                break;
            case VK_PRESENT_MODE_SHARED_CONTINUOUS_REFRESH_KHR:
                std::cout << "Avaliable Present Mode: Shared Continuous Refresh" << std::endl; 
                break;
            case VK_PRESENT_MODE_MAX_ENUM_KHR:
                std::cout << "Avaliable Present Mode: Max Enum" << std::endl; 
                break;
            default:
                std::cout << "Avaliable Present Mode: Unkown" << std::endl; 
                break;
